...
MississippiR <- dataLoad(filepath = filepath_IA, lat = lat_IA, long = long_IA, tz = tz_IA)
#
# reformat data ----------------------------------------------------------
MississippiR <- dataPrep(MississippiR)
#
...
# data has gap during middle of year. see if you can find replacement
# Sacramento River near Sacramento CA, USGS gage number 11447890
#
# load data ------------------------------------------------------------
...
SacramentoR <- dataLoad(filepath = filepath_CA, lat = lat_CA, long = long_CA, tz = tz_CA)
#
# reformat data ----------------------------------------------------------
SacramentoR <- dataPrep(SacramentoR)
#
# run metabolism model ---------------------------------------------------
model_Sacramento <- 
...
NorthBranch <- dataLoad(filepath = filepath_CT, lat = lat_CT, long = long_CT, tz = tz_CT)
#
# reformat data ----------------------------------------------------------
NorthBranch <- dataPrep(NorthBranch)
#
# run metabolism model ---------------------------------------------------
model_NorthBranch <- 
...
metabolismPlot(model_Mississippi, 
               filename = "./FinalProject/figures/IA_MississippiR_MetabolismModel.png")
```
