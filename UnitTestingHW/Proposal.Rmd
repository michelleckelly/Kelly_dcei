...
output: 
  pdf_document:
    fig_caption: true
bibliography: input_figures_bib/Proposal_citations.bib
---
...
knitr::include_graphics("input_figures_bib/Bernhardt2018.png")
```
...
knitr::include_graphics("input_figures_bib/Vannote1980_edit.png")
```

Recently, Bernhardt et. al proposed a conceptual framework of stream "metabolic regimes", suggesting dominant annual patterns of GPP and ER dynamics for river ecosystems subjected to varying physical and biochemical conditions [-@Bernhardt2018]. We propose to "ground-truth" the metabolism regime concept by asking (1) can we see these propsed regimes in real stream data, and (2) can use a metabolism profile to "diagnose" local stream conditions, such as annual precipitation patterns, stream size, or surrounding land use?  
