...
```{r plotting, fig.height=3, fig.width = 8, echo = FALSE, warning = FALSE, fig.cap="An annual estimate of GPP and ER in the Mississippi River, January 2017 - November 2017. \\label{metab_plot}"}
